...
major_df = pd.read_csv('https://fivethirtyeight.datasettes.com/fivethirtyeight/college-majors~2Fmajors-list.csv?_size=max')
course_df = pd.read_csv('https://waf.cs.illinois.edu/discovery/course-catalog.csv')
...
rand_df = create_random_dataframe()
rand_df.to_csv('random_df.csv')